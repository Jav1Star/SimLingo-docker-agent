...
class Qwen2FlashAttention2(Qwen2Attention):
    ...
    def forward(
        ...
        # === [修改] 彻底禁用该调用，防止 NameError ===
        # raise NotImplementedError("Flash Attention 2 is disabled. Please check QWEN2_ATTENTION_CLASSES mapping.")
...
QWEN2_ATTENTION_CLASSES = {
    ...
    # "flash_attention_2": Qwen2SdpaAttention,      # <--- 【偷梁换柱】强制重定向到 SDPA
